...
| --- | --- | --- | --- | --- |
| `conversationId` | [`String`](../scalars/string-scalar.md)! | `n/a` | No | The Intercom conversation ID to link. |
...
| `issueId` | [`String`](../scalars/string-scalar.md)! | `n/a` | No | The issue for which to link the Intercom conversation. Can be a UUID or issue identifier (e.g., 'LIN-123'). |
| `partId` | [`String`](../scalars/string-scalar.md) | `n/a` | No | An optional Intercom conversation part ID to link to |
