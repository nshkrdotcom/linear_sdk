...
| `customView` | [`CustomView`](custom_view-object.md)! | `none` | No | The custom view subscribed to. |
| `customer` | [`Customer`](customer-object.md) | `none` | No | The customer associated with the notification subscription. |
| `cycle` | [`Cycle`](cycle-object.md) | `none` | No | The contextual cycle view associated with the notification subscription. |
