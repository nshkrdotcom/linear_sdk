...
| `oauthClientApproval` | [`OauthClientApproval`](oauth_client_approval-object.md)! | `none` | No | The OAuth client approval request related to the notification. |
| `oauthClientApprovalId` | [`String`](../scalars/string-scalar.md)! | `none` | No | Related OAuth client approval request ID. |
