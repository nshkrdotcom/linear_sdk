...
| `customerNeed` | [`CustomerNeed`](customer_need-object.md)! | `none` | No | The customer need related to the notification. |
| `customerNeedId` | [`String`](../scalars/string-scalar.md)! | `none` | No | Related customer need. |
...
| `relatedIssue` | [`Issue`](issue-object.md) | `none` | No | The issue related to the notification. |
| `relatedProject` | [`Project`](project-object.md) | `none` | No | The project related to the notification. |
