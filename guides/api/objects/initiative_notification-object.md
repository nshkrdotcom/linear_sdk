...
| `initiative` | [`Initiative`](initiative-object.md) | `none` | No | The initiative related to the notification. |
| `initiativeId` | [`String`](../scalars/string-scalar.md)! | `none` | No | Related initiative ID. |
| `initiativeUpdate` | [`InitiativeUpdate`](initiative_update-object.md) | `none` | No | The initiative update related to the notification. |
| `initiativeUpdateHealth` | [`String`](../scalars/string-scalar.md) | `none` | No | [Internal] Initiative update health for new updates. |
| `initiativeUpdateId` | [`String`](../scalars/string-scalar.md) | `none` | No | Related initiative update ID. |
