...
| `document` | [`Document`](document-object.md) | `none` | No | The document related to the notification. |
...
| `project` | [`Project`](project-object.md)! | `none` | No | The project related to the notification. |
| `projectId` | [`String`](../scalars/string-scalar.md)! | `none` | No | Related project ID. |
| `projectMilestoneId` | [`String`](../scalars/string-scalar.md) | `none` | No | Related project milestone ID. |
| `projectUpdate` | [`ProjectUpdate`](project_update-object.md) | `none` | No | The project update related to the notification. |
| `projectUpdateHealth` | [`String`](../scalars/string-scalar.md) | `none` | No | [Internal] Project update health for new updates. |
| `projectUpdateId` | [`String`](../scalars/string-scalar.md) | `none` | No | Related project update ID. |
