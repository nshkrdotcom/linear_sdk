...
| `type` | [`IssueStatusChangedNotificationType`](../scalars/issue_status_changed_notification_type-scalar.md)! | `none` | No | A terminal issue status change notification type. |
