...
| `customer` | [`Customer`](customer-object.md)! | `none` | No | The customer related to the notification. |
| `customerId` | [`String`](../scalars/string-scalar.md)! | `none` | No | Related customer. |
