...
- Root: `Queries`
- Return Type: [`DocumentConnection`](../objects/document_connection-object.md)!
...
| `filter` | [`DocumentFilter`](../input-objects/document_filter-input.md) | `n/a` | No | Filter returned documents. |
