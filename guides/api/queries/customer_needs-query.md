...
- Root: `Queries`
- Return Type: [`CustomerNeedConnection`](../objects/customer_need_connection-object.md)!
...
| `filter` | [`CustomerNeedFilter`](../input-objects/customer_need_filter-input.md) | `n/a` | No | Filter returned customers needs. |
