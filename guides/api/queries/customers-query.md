...
- Root: `Queries`
- Return Type: [`CustomerConnection`](../objects/customer_connection-object.md)!
...
| `filter` | [`CustomerFilter`](../input-objects/customer_filter-input.md) | `n/a` | No | Filter returned customers. |
...
| `sorts` | [[`CustomerSortInput`](../input-objects/customer_sort_input-input.md)!] | `n/a` | No | Sort returned customers. |
