...
- Root: `Queries`
- Return Type: [`AttachmentConnection`](../objects/attachment_connection-object.md)!
...
| `filter` | [`AttachmentFilter`](../input-objects/attachment_filter-input.md) | `n/a` | No | Filter returned attachments. |
