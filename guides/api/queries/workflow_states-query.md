...
- Root: `Queries`
- Return Type: [`WorkflowStateConnection`](../objects/workflow_state_connection-object.md)!
...
| `filter` | [`WorkflowStateFilter`](../input-objects/workflow_state_filter-input.md) | `n/a` | No | Filter returned workflow states. |
