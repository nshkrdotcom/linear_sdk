...
- Root: `Queries`
- Return Type: [`ProjectLabelConnection`](../objects/project_label_connection-object.md)!
...
| `filter` | [`ProjectLabelFilter`](../input-objects/project_label_filter-input.md) | `n/a` | No | Filter returned project labels. |
