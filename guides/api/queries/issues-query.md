...
- Root: `Queries`
- Return Type: [`IssueConnection`](../objects/issue_connection-object.md)!
...
| `filter` | [`IssueFilter`](../input-objects/issue_filter-input.md) | `n/a` | No | Filter returned issues. |
...
| `sort` | [[`IssueSortInput`](../input-objects/issue_sort_input-input.md)!] | `n/a` | No | [INTERNAL] Sort returned issues. |
