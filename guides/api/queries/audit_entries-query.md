...
- Root: `Queries`
- Return Type: [`AuditEntryConnection`](../objects/audit_entry_connection-object.md)!
...
| `filter` | [`AuditEntryFilter`](../input-objects/audit_entry_filter-input.md) | `n/a` | No | Filter returned audit entries. |
