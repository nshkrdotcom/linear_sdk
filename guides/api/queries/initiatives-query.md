...
- Root: `Queries`
- Return Type: [`InitiativeConnection`](../objects/initiative_connection-object.md)!
...
| `filter` | [`InitiativeFilter`](../input-objects/initiative_filter-input.md) | `n/a` | No | Filter returned initiatives. |
...
| `sort` | [[`InitiativeSortInput`](../input-objects/initiative_sort_input-input.md)!] | `n/a` | No | [INTERNAL] Sort returned initiatives. |
