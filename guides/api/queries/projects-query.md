...
- Root: `Queries`
- Return Type: [`ProjectConnection`](../objects/project_connection-object.md)!
...
| `filter` | [`ProjectFilter`](../input-objects/project_filter-input.md) | `n/a` | No | Filter returned projects. |
...
| `sort` | [[`ProjectSortInput`](../input-objects/project_sort_input-input.md)!] | `n/a` | No | [INTERNAL] Sort returned projects. |
