...
- Root: `Queries`
- Return Type: [`ReleasePipelineConnection`](../objects/release_pipeline_connection-object.md)!
...
| `filter` | [`ReleasePipelineFilter`](../input-objects/release_pipeline_filter-input.md) | `n/a` | No | Filter returned release pipelines. |
