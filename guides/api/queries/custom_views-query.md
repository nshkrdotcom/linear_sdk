...
- Root: `Queries`
- Return Type: [`CustomViewConnection`](../objects/custom_view_connection-object.md)!
...
| `filter` | [`CustomViewFilter`](../input-objects/custom_view_filter-input.md) | `n/a` | No | Filter returned custom views. |
...
| `sort` | [[`CustomViewSortInput`](../input-objects/custom_view_sort_input-input.md)!] | `n/a` | No | [INTERNAL] Sort returned custom views. |
