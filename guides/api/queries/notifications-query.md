...
- Root: `Queries`
- Return Type: [`NotificationConnection`](../objects/notification_connection-object.md)!
...
| `filter` | [`NotificationFilter`](../input-objects/notification_filter-input.md) | `n/a` | No | Filters returned notifications. |
