...
- Root: `Queries`
- Return Type: [`ProjectMilestoneConnection`](../objects/project_milestone_connection-object.md)!
...
| `filter` | [`ProjectMilestoneFilter`](../input-objects/project_milestone_filter-input.md) | `n/a` | No | Filter returned project milestones. |
