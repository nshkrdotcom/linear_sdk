...
- Root: `Queries`
- Return Type: [`InitiativeUpdateConnection`](../objects/initiative_update_connection-object.md)!
...
| `filter` | [`InitiativeUpdateFilter`](../input-objects/initiative_update_filter-input.md) | `n/a` | No | Filter returned initiative updates. |
