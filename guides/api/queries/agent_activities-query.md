...
- Root: `Queries`
- Return Type: [`AgentActivityConnection`](../objects/agent_activity_connection-object.md)!
...
| `filter` | [`AgentActivityFilter`](../input-objects/agent_activity_filter-input.md) | `n/a` | No | Filter returned agent activities. |
