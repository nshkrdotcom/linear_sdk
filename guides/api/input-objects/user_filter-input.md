...
| `and` | [[`UserFilter`](user_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the user. |
...
| `or` | [[`UserFilter`](user_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the user. |
