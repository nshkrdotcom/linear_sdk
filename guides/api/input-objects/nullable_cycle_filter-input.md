...
| --- | --- | --- | --- | --- |
| `and` | [[`NullableCycleFilter`](nullable_cycle_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the cycle. |
...
| `or` | [[`NullableCycleFilter`](nullable_cycle_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the cycle. |
