...
| --- | --- | --- | --- | --- |
| `and` | [[`NullableCommentFilter`](nullable_comment_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the comment. |
...
| `or` | [[`NullableCommentFilter`](nullable_comment_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the comment. |
