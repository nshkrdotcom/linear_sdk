...
| `and` | [[`NullableProjectFilter`](nullable_project_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the project. |
...
| `or` | [[`NullableProjectFilter`](nullable_project_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the project. |
