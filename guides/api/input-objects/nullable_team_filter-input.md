...
| `and` | [[`NullableTeamFilter`](nullable_team_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the team. |
...
| `or` | [[`NullableTeamFilter`](nullable_team_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the team. |
