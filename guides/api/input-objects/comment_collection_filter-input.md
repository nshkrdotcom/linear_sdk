...
| --- | --- | --- | --- | --- |
| `and` | [[`CommentCollectionFilter`](comment_collection_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the comment. |
...
| `every` | [`CommentFilter`](comment_filter-input.md) | `n/a` | No | Filters that needs to be matched by all comments. |
...
| `or` | [[`CommentCollectionFilter`](comment_collection_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the comment. |
...
| `some` | [`CommentFilter`](comment_filter-input.md) | `n/a` | No | Filters that needs to be matched by some comments. |
