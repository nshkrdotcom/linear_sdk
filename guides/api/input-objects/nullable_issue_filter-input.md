...
| `and` | [[`NullableIssueFilter`](nullable_issue_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the issue. |
...
| `or` | [[`NullableIssueFilter`](nullable_issue_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the issue. |
