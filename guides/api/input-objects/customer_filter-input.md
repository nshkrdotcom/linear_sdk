...
| --- | --- | --- | --- | --- |
| `and` | [[`CustomerFilter`](customer_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the customer. |
...
| `or` | [[`CustomerFilter`](customer_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the customer. |
