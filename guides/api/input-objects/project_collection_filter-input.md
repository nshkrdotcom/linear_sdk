...
| `and` | [[`ProjectCollectionFilter`](project_collection_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the project. |
...
| `every` | [`ProjectFilter`](project_filter-input.md) | `n/a` | No | Filters that needs to be matched by all projects. |
...
| `or` | [[`ProjectCollectionFilter`](project_collection_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the project. |
...
| `some` | [`ProjectFilter`](project_filter-input.md) | `n/a` | No | Filters that needs to be matched by some projects. |
