...
| --- | --- | --- | --- | --- |
| `and` | [[`IssueLabelFilter`](issue_label_filter-input.md)!] | `n/a` | No | Compound filters, all of which need to be matched by the label. |
...
| `or` | [[`IssueLabelFilter`](issue_label_filter-input.md)!] | `n/a` | No | Compound filters, one of which need to be matched by the label. |
