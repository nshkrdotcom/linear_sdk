defmodule LinearSDK.Queries.Notifications do
  @moduledoc ~S'''
  GraphQL query field `notifications`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.NotificationConnection!
  ...
  | `filter` | LinearSDK.Inputs.NotificationFilter | `n/a` | No | Filters returned notifications. |
