defmodule LinearSDK.Queries.InitiativeToProjects do
  @moduledoc ~S'''
  GraphQL query field `initiativeToProjects`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.InitiativeToProjectConnection!
