defmodule LinearSDK.Queries.IntegrationTemplates do
  @moduledoc ~S'''
  GraphQL query field `integrationTemplates`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.IntegrationTemplateConnection!
