defmodule LinearSDK.Queries.ReleasePipelines do
  @moduledoc ~S'''
  GraphQL query field `releasePipelines`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.ReleasePipelineConnection!
  ...
  | `filter` | LinearSDK.Inputs.ReleasePipelineFilter | `n/a` | No | Filter returned release pipelines. |
