defmodule LinearSDK.Queries.Projects do
  @moduledoc ~S'''
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.ProjectConnection!
  ...
  | `filter` | LinearSDK.Inputs.ProjectFilter | `n/a` | No | Filter returned projects. |
  ...
  | `sort` | [LinearSDK.Inputs.ProjectSortInput!] | `n/a` | No | [INTERNAL] Sort returned projects. |
  '''
end
