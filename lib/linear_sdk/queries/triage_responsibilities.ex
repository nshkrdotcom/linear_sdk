defmodule LinearSDK.Queries.TriageResponsibilities do
  @moduledoc ~S'''
  GraphQL query field `triageResponsibilities`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.TriageResponsibilityConnection!
