defmodule LinearSDK.Queries.ReleaseStages do
  @moduledoc ~S'''
  GraphQL query field `releaseStages`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.ReleaseStageConnection!
  ...
  | `filter` | LinearSDK.Inputs.ReleaseStageFilter | `n/a` | No | Filter returned release stages. |
