defmodule LinearSDK.Queries.Initiatives do
  @moduledoc ~S'''
  GraphQL query field `initiatives`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.InitiativeConnection!
  ...
  | `filter` | LinearSDK.Inputs.InitiativeFilter | `n/a` | No | Filter returned initiatives. |
  ...
  | `sort` | [LinearSDK.Inputs.InitiativeSortInput!] | `n/a` | No | [INTERNAL] Sort returned initiatives. |
  '''
end
