defmodule LinearSDK.Queries.WorkflowStates do
  @moduledoc ~S'''
  GraphQL query field `workflowStates`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.WorkflowStateConnection!
  ...
  | `filter` | LinearSDK.Inputs.WorkflowStateFilter | `n/a` | No | Filter returned workflow states. |
