defmodule LinearSDK.Queries.Cycles do
  @moduledoc ~S'''
  GraphQL query field `cycles`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.CycleConnection!
  ...
  | `filter` | LinearSDK.Inputs.CycleFilter | `n/a` | No | Filter returned users. |
