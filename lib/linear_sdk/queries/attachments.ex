defmodule LinearSDK.Queries.Attachments do
  @moduledoc ~S'''
  GraphQL query field `attachments`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.AttachmentConnection!
  ...
  | `filter` | LinearSDK.Inputs.AttachmentFilter | `n/a` | No | Filter returned attachments. |
