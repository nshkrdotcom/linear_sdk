defmodule LinearSDK.Queries.ProjectMilestones do
  @moduledoc ~S'''
  GraphQL query field `projectMilestones`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.ProjectMilestoneConnection!
  ...
  | `filter` | LinearSDK.Inputs.ProjectMilestoneFilter | `n/a` | No | Filter returned project milestones. |
