defmodule LinearSDK.Queries.Customers do
  @moduledoc ~S'''
  GraphQL query field `customers`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.CustomerConnection!
  ...
  | `filter` | LinearSDK.Inputs.CustomerFilter | `n/a` | No | Filter returned customers. |
  ...
  | `sorts` | [LinearSDK.Inputs.CustomerSortInput!] | `n/a` | No | Sort returned customers. |
  '''
end
