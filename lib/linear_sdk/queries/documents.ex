defmodule LinearSDK.Queries.Documents do
  @moduledoc ~S'''
  GraphQL query field `documents`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.DocumentConnection!
  ...
  | `filter` | LinearSDK.Inputs.DocumentFilter | `n/a` | No | Filter returned documents. |
