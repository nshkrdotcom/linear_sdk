defmodule LinearSDK.Queries.AdministrableTeams do
  @moduledoc ~S'''
  GraphQL query field `administrableTeams`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.TeamConnection!
  ...
  | `filter` | LinearSDK.Inputs.TeamFilter | `n/a` | No | Filter returned teams. |
