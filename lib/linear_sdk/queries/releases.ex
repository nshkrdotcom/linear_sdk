defmodule LinearSDK.Queries.Releases do
  @moduledoc ~S'''
  GraphQL query field `releases`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.ReleaseConnection!
  ...
  | `filter` | LinearSDK.Inputs.ReleaseFilter | `n/a` | No | Filter returned releases. |
  ...
  | `sort` | [LinearSDK.Inputs.ReleaseSortInput!] | `n/a` | No | [ALPHA] Sort returned releases. |
  '''
end
