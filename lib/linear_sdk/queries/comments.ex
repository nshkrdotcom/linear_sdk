defmodule LinearSDK.Queries.Comments do
  @moduledoc ~S'''
  GraphQL query field `comments`.
  ...
  - Root Type: `Query`
  - Return Type: LinearSDK.Objects.CommentConnection!
  ...
  | `filter` | LinearSDK.Inputs.CommentFilter | `n/a` | No | Filter returned comments. |
