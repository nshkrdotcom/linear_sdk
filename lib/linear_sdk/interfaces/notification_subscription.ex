defmodule LinearSDK.Interfaces.NotificationSubscription do
  @moduledoc ~S'''
  GraphQL interface `NotificationSubscription`.
  ...
  - Implements: LinearSDK.Interfaces.Entity, LinearSDK.Interfaces.Node
  - Possible Types: LinearSDK.Objects.CustomViewNotificationSubscription, LinearSDK.Objects.CustomerNotificationSubscription, LinearSDK.Objects.CycleNotificationSubscription, LinearSDK.Objects.InitiativeNotificationSubscription, LinearSDK.Objects.LabelNotificationSubscription, LinearSDK.Objects.ProjectNotificationSubscription, LinearSDK.Objects.TeamNotificationSubscription, LinearSDK.Objects.UserNotificationSubscription
  ...
  | `cycle` | LinearSDK.Objects.Cycle | `none` | No | The contextual cycle view associated with the notification subscription. |
