defmodule LinearSDK.Inputs.NullableTeamFilter do
  @moduledoc ~S'''
  GraphQL input_object `NullableTeamFilter`.
  ...
  | `and` | [LinearSDK.Inputs.NullableTeamFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the team. |
  ...
  | `or` | [LinearSDK.Inputs.NullableTeamFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the team. |
