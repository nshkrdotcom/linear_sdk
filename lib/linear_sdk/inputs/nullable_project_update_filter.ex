defmodule LinearSDK.Inputs.NullableProjectUpdateFilter do
  @moduledoc ~S'''
  GraphQL input_object `NullableProjectUpdateFilter`.
  ...
  | --- | --- | --- | --- | --- |
  | `and` | [LinearSDK.Inputs.NullableProjectUpdateFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the project update. |
  ...
  | `or` | [LinearSDK.Inputs.NullableProjectUpdateFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the project update. |
