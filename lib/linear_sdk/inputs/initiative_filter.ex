defmodule LinearSDK.Inputs.InitiativeFilter do
  @moduledoc ~S'''
  GraphQL input_object `InitiativeFilter`.
  ...
  | `and` | [LinearSDK.Inputs.InitiativeFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the initiative. |
  ...
  | `or` | [LinearSDK.Inputs.InitiativeFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the initiative. |
