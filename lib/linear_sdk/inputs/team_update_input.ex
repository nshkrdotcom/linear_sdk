defmodule LinearSDK.Inputs.TeamUpdateInput do
  @moduledoc ~S'''
  GraphQL input_object `TeamUpdateInput`.
  ...
  | --- | --- | --- | --- | --- |
  | `aiDiscussionSummariesEnabled` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether to enable AI discussion summaries for issues. |
  | `aiThreadSummariesEnabled` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether to enable resolved thread AI summaries. |
  | `allMembersCanJoin` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether all members in the workspace can join the team. Only used for public teams. |
  | `autoArchivePeriod` | LinearSDK.Scalars.Float | `n/a` | No | Period after which closed and completed issues are automatically archived, in months. |
  | `autoCloseChildIssues` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether to automatically close all sub-issues when a parent issue in this team is closed. |
  | `autoCloseParentIssues` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether to automatically close a parent issue in this team if all its sub-issues are closed. |
  ...
  | `cycleEnabledStartDate` | LinearSDK.Scalars.DateTime | `n/a` | No | The date to begin cycles on. |
  ...
  | `cycleLockToActive` | LinearSDK.Scalars.Boolean | `n/a` | No | Only allow issues with cycles in Active Issues. |
  ...
  | `defaultIssueStateId` | LinearSDK.Scalars.String | `n/a` | No | Default status for newly created issues. |
  ...
  | `handleSubTeamsOnRetirement` | LinearSDK.Enums.TeamRetirementSubTeamHandling | `n/a` | No | [Internal] How to handle sub-teams when retiring. Required if the team has active sub-teams. |
  ...
  | `joinByDefault` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether new users should join this team by default. Mutation restricted to workspace admins or owners! |
  | `key` | LinearSDK.Scalars.String | `n/a` | No | The key of the team. |
  ...
  | `private` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether the team is private or not. |
  ...
  | `retiredAt` | LinearSDK.Scalars.DateTime | `n/a` | No | When the team was retired. |
  | `scimManaged` | LinearSDK.Scalars.Boolean | `n/a` | No | Whether the team is managed by SCIM integration. Mutation restricted to workspace admins or owners and only unsetting is allowed! |
  | `securitySettings` | LinearSDK.Inputs.TeamSecuritySettingsInput | `n/a` | No | The security settings for the team. |
