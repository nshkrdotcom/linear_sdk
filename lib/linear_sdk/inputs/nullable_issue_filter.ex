defmodule LinearSDK.Inputs.NullableIssueFilter do
  @moduledoc ~S'''
  GraphQL input_object `NullableIssueFilter`.
  ...
  | `and` | [LinearSDK.Inputs.NullableIssueFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the issue. |
  ...
  | `or` | [LinearSDK.Inputs.NullableIssueFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the issue. |
