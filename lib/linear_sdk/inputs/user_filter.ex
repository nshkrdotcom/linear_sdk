defmodule LinearSDK.Inputs.UserFilter do
  @moduledoc ~S'''
  GraphQL input_object `UserFilter`.
  ...
  | `and` | [LinearSDK.Inputs.UserFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the user. |
  ...
  | `or` | [LinearSDK.Inputs.UserFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the user. |
