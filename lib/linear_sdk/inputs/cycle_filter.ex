defmodule LinearSDK.Inputs.CycleFilter do
  @moduledoc ~S'''
  GraphQL input_object `CycleFilter`.
  ...
  | --- | --- | --- | --- | --- |
  | `and` | [LinearSDK.Inputs.CycleFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the cycle. |
  ...
  | `or` | [LinearSDK.Inputs.CycleFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the cycle. |
