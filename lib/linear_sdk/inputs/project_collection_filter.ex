defmodule LinearSDK.Inputs.ProjectCollectionFilter do
  @moduledoc ~S'''
  GraphQL input_object `ProjectCollectionFilter`.
  ...
  | `and` | [LinearSDK.Inputs.ProjectCollectionFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the project. |
  ...
  | `every` | LinearSDK.Inputs.ProjectFilter | `n/a` | No | Filters that needs to be matched by all projects. |
  ...
  | `or` | [LinearSDK.Inputs.ProjectCollectionFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the project. |
  ...
  | `some` | LinearSDK.Inputs.ProjectFilter | `n/a` | No | Filters that needs to be matched by some projects. |
