defmodule LinearSDK.Inputs.NullableCustomerFilter do
  @moduledoc ~S'''
  GraphQL input_object `NullableCustomerFilter`.
  ...
  | --- | --- | --- | --- | --- |
  | `and` | [LinearSDK.Inputs.NullableCustomerFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the customer. |
  ...
  | `or` | [LinearSDK.Inputs.NullableCustomerFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the customer. |
