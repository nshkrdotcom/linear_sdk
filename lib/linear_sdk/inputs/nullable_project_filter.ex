defmodule LinearSDK.Inputs.NullableProjectFilter do
  @moduledoc ~S'''
  GraphQL input_object `NullableProjectFilter`.
  ...
  | `and` | [LinearSDK.Inputs.NullableProjectFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the project. |
  ...
  | `or` | [LinearSDK.Inputs.NullableProjectFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the project. |
