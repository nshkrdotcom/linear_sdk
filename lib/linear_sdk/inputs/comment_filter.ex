defmodule LinearSDK.Inputs.CommentFilter do
  @moduledoc ~S'''
  GraphQL input_object `CommentFilter`.
  ...
  | --- | --- | --- | --- | --- |
  | `and` | [LinearSDK.Inputs.CommentFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the comment. |
  ...
  | `or` | [LinearSDK.Inputs.CommentFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the comment. |
