defmodule LinearSDK.Inputs.IssueFilter do
  @moduledoc ~S'''
  GraphQL input_object `IssueFilter`.
  ...
  | `and` | [LinearSDK.Inputs.IssueFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the issue. |
  ...
  | `or` | [LinearSDK.Inputs.IssueFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the issue. |
