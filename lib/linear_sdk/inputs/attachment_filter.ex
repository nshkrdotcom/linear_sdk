defmodule LinearSDK.Inputs.AttachmentFilter do
  @moduledoc ~S'''
  GraphQL input_object `AttachmentFilter`.
  ...
  | --- | --- | --- | --- | --- |
  | `and` | [LinearSDK.Inputs.AttachmentFilter!] | `n/a` | No | Compound filters, all of which need to be matched by the attachment. |
  ...
  | `or` | [LinearSDK.Inputs.AttachmentFilter!] | `n/a` | No | Compound filters, one of which need to be matched by the attachment. |
