defmodule LinearSDK.Inputs.CustomViewUpdateInput do
  @moduledoc ~S'''
  GraphQL input_object `CustomViewUpdateInput`.
  ...
  | `initiativeId` | LinearSDK.Scalars.String | `n/a` | No | [Internal] The id of the initiative associated with the custom view. |
  ...
  | `projectId` | LinearSDK.Scalars.String | `n/a` | No | [Internal] The id of the project associated with the custom view. |
