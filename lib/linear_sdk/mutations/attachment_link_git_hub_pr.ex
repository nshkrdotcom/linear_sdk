defmodule LinearSDK.Mutations.AttachmentLinkGitHubPr do
  @moduledoc ~S'''
  GraphQL mutation field `attachmentLinkGitHubPR`.
  ...
  | `issueId` | LinearSDK.Scalars.String! | `n/a` | No | The issue for which to link the GitHub pull request. Can be a UUID or issue identifier (e.g., 'LIN-123'). |
  | `linkKind` | LinearSDK.Enums.GitLinkKind | `n/a` | No | [Internal] The kind of link between the issue and the pull request. |
  | `title` | LinearSDK.Scalars.String | `n/a` | No | The title to use for the attachment. |
  | `url` | LinearSDK.Scalars.String! | `n/a` | No | The URL of the GitHub pull request to link. |
  '''
end
