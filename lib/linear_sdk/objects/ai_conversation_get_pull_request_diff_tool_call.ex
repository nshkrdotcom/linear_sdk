defmodule LinearSDK.Objects.AiConversationGetPullRequestDiffToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationGetPullRequestDiffToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationGetPullRequestDiffToolCallArgs | `none` | No | The arguments to the tool call. |
