defmodule LinearSDK.Objects.ProjectNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `ProjectNotificationSubscription`.
  ...
  | `project` | LinearSDK.Objects.Project! | `none` | No | The project subscribed to. |
