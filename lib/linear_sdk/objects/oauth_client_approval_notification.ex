defmodule LinearSDK.Objects.OauthClientApprovalNotification do
  @moduledoc ~S'''
  GraphQL object `OauthClientApprovalNotification`.
  ...
  | `oauthClientApproval` | LinearSDK.Objects.OauthClientApproval! | `none` | No | The OAuth client approval request related to the notification. |
  | `oauthClientApprovalId` | LinearSDK.Scalars.String! | `none` | No | Related OAuth client approval request ID. |
