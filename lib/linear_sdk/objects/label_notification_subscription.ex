defmodule LinearSDK.Objects.LabelNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `LabelNotificationSubscription`.
  ...
  | `label` | LinearSDK.Objects.IssueLabel! | `none` | No | The label subscribed to. |
