defmodule LinearSDK.Objects.ProjectUpdate do
  @moduledoc ~S'''
  GraphQL object `ProjectUpdate`.
  ...
  | `health` | LinearSDK.Enums.ProjectUpdateHealthType! | `none` | No | The health of the project at the time of the update. |
  | `id` | LinearSDK.Scalars.ID! | `none` | No | The unique identifier of the entity. |
  | `infoSnapshot` | LinearSDK.Scalars.JSONObject | `none` | No | [Internal] Serialized JSON representing current state of the project properties when posting the project update. |
  | `isDiffHidden` | LinearSDK.Scalars.Boolean! | `none` | No | Whether project update diff should be hidden. |
  | `isStale` | LinearSDK.Scalars.Boolean! | `none` | No | Whether the project update is stale. |
  | `project` | LinearSDK.Objects.Project! | `none` | No | The project that the update is associated with. |
  | `reactionData` | LinearSDK.Scalars.JSONObject! | `none` | No | Emoji reaction summary, grouped by emoji type. |
  | `reactions` | [LinearSDK.Objects.Reaction!]! | `none` | No | Reactions associated with the project update. |
  | `slugId` | LinearSDK.Scalars.String! | `none` | No | The update's unique URL slug. |
  | `updatedAt` | LinearSDK.Scalars.DateTime! | `none` | No | The last time at which the entity was meaningfully updated. This is the same as the creation time if the entity hasn't |
  | `url` | LinearSDK.Scalars.String! | `none` | No | The URL to the project update. |
