defmodule LinearSDK.Objects.AiConversationGetPullRequestFileToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationGetPullRequestFileToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationGetPullRequestFileToolCallArgs | `none` | No | The arguments to the tool call. |
