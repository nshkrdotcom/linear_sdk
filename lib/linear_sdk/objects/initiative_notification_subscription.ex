defmodule LinearSDK.Objects.InitiativeNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `InitiativeNotificationSubscription`.
  ...
  | `initiative` | LinearSDK.Objects.Initiative! | `none` | No | The initiative subscribed to. |
