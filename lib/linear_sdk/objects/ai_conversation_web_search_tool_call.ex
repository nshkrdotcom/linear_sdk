defmodule LinearSDK.Objects.AiConversationWebSearchToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationWebSearchToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationWebSearchToolCallArgs | `none` | No | The arguments to the tool call. |
