defmodule LinearSDK.Objects.AiConversationCreateEntityToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationCreateEntityToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationCreateEntityToolCallArgs | `none` | No | The arguments to the tool call. |
