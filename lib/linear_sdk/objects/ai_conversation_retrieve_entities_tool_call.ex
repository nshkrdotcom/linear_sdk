defmodule LinearSDK.Objects.AiConversationRetrieveEntitiesToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationRetrieveEntitiesToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationRetrieveEntitiesToolCallArgs | `none` | No | The arguments to the tool call. |
