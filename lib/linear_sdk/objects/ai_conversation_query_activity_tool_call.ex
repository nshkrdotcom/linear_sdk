defmodule LinearSDK.Objects.AiConversationQueryActivityToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationQueryActivityToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationQueryActivityToolCallArgs | `none` | No | The arguments to the tool call. |
