defmodule LinearSDK.Objects.CustomViewNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `CustomViewNotificationSubscription`.
  ...
  | `customView` | LinearSDK.Objects.CustomView! | `none` | No | The custom view subscribed to. |
