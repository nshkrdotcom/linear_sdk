defmodule LinearSDK.Objects.CustomerNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `CustomerNotificationSubscription`.
  ...
  | `customer` | LinearSDK.Objects.Customer! | `none` | No | The customer subscribed to. |
