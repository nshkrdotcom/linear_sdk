defmodule LinearSDK.Objects.AiConversationUpdateEntityToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationUpdateEntityToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationUpdateEntityToolCallArgs | `none` | No | The arguments to the tool call. |
