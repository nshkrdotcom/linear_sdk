defmodule LinearSDK.Objects.CustomerNotification do
  @moduledoc ~S'''
  GraphQL object `CustomerNotification`.
  ...
  | `customer` | LinearSDK.Objects.Customer! | `none` | No | The customer related to the notification. |
  | `customerId` | LinearSDK.Scalars.String! | `none` | No | Related customer. |
