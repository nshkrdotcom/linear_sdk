defmodule LinearSDK.Objects.AiConversationQueryUpdatesToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationQueryUpdatesToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationQueryUpdatesToolCallArgs | `none` | No | The arguments to the tool call. |
