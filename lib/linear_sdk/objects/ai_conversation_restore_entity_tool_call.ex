defmodule LinearSDK.Objects.AiConversationRestoreEntityToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationRestoreEntityToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationRestoreEntityToolCallArgs | `none` | No | The arguments to the tool call. |
