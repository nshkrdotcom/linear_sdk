defmodule LinearSDK.Objects.AiConversationCodeIntelligenceToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationCodeIntelligenceToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationCodeIntelligenceToolCallArgs | `none` | No | The arguments to the tool call. |
