defmodule LinearSDK.Objects.AiConversationDeleteEntityToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationDeleteEntityToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationDeleteEntityToolCallArgs | `none` | No | The arguments to the tool call. |
