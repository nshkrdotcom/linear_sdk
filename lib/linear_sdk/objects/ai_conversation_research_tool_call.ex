defmodule LinearSDK.Objects.AiConversationResearchToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationResearchToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationResearchToolCallArgs | `none` | No | The arguments to the tool call. |
  ...
  | `result` | LinearSDK.Objects.AiConversationResearchToolCallResult | `none` | No | The result of the tool call. |
  '''
end
