defmodule LinearSDK.Objects.ProjectNotification do
  @moduledoc ~S'''
  GraphQL object `ProjectNotification`.
  ...
  | `project` | LinearSDK.Objects.Project! | `none` | No | The project related to the notification. |
  | `projectId` | LinearSDK.Scalars.String! | `none` | No | Related project ID. |
  | `projectMilestoneId` | LinearSDK.Scalars.String | `none` | No | Related project milestone ID. |
  | `projectUpdate` | LinearSDK.Objects.ProjectUpdate | `none` | No | The project update related to the notification. |
  | `projectUpdateHealth` | LinearSDK.Scalars.String | `none` | No | [Internal] Project update health for new updates. |
  | `projectUpdateId` | LinearSDK.Scalars.String | `none` | No | Related project update ID. |
