defmodule LinearSDK.Objects.UserNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `UserNotificationSubscription`.
  ...
  | `user` | LinearSDK.Objects.User! | `none` | No | The user subscribed to. |
