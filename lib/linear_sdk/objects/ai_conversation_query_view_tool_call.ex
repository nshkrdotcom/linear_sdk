defmodule LinearSDK.Objects.AiConversationQueryViewToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationQueryViewToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationQueryViewToolCallArgs | `none` | No | The arguments to the tool call. |
