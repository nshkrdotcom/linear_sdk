defmodule LinearSDK.Objects.AiConversationInvokeMcpToolToolCall do
  @moduledoc ~S'''
  GraphQL object `AiConversationInvokeMcpToolToolCall`.
  ...
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationInvokeMcpToolToolCallArgs | `none` | No | The arguments to the tool call. |
