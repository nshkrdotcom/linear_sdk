defmodule LinearSDK.Objects.PullRequestNotification do
  @moduledoc ~S'''
  GraphQL object `PullRequestNotification`.
  ...
  | `pullRequest` | LinearSDK.Objects.PullRequest! | `none` | No | The pull request related to the notification. |
  | `pullRequestCommentId` | LinearSDK.Scalars.String | `none` | No | Related pull request comment ID. Null if the notification is not related to a pull request comment. |
  | `pullRequestId` | LinearSDK.Scalars.String! | `none` | No | Related pull request. |
