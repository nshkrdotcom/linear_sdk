defmodule LinearSDK.Objects.AiConversationEntityCardWidget do
  @moduledoc ~S'''
  GraphQL object `AiConversationEntityCardWidget`.
  ...
  - Implements: LinearSDK.Interfaces.AiConversationBaseWidget

  ## Fields

  | Name | Type | Arguments | Deprecated | Description |
  | --- | --- | --- | --- | --- |
  | `args` | LinearSDK.Objects.AiConversationEntityCardWidgetArgs | `none` | No | The arguments to the widget. |
