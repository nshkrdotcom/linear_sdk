defmodule LinearSDK.Objects.TeamNotificationSubscription do
  @moduledoc ~S'''
  GraphQL object `TeamNotificationSubscription`.
  ...
  | `team` | LinearSDK.Objects.Team! | `none` | No | The team subscribed to. |
