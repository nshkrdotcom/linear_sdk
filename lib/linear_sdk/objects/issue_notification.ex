defmodule LinearSDK.Objects.IssueNotification do
  @moduledoc ~S'''
  GraphQL object `IssueNotification`.
  ...
  | `issue` | LinearSDK.Objects.Issue! | `none` | No | The issue related to the notification. |
  | `issueId` | LinearSDK.Scalars.String! | `none` | No | Related issue ID. |
  ...
  | `subscriptions` | [LinearSDK.Interfaces.NotificationSubscription!] | `none` | No | The subscriptions related to the notification. |
  | `subtitle` | LinearSDK.Scalars.String! | `none` | No | [Internal] Notification subtitle. |
  | `team` | LinearSDK.Objects.Team! | `none` | No | The team related to the issue notification. |
