defmodule LinearSDK.Objects.IssueNewCommentNotificationWebhookPayload do
  @moduledoc ~S'''
  GraphQL object `IssueNewCommentNotificationWebhookPayload`.
  ...
  | `type` | LinearSDK.Scalars.IssueNewCommentNotificationType! | `none` | No | An issue new comment notification type. |
