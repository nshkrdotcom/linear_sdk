defmodule LinearSDK.Objects.CustomerNeedNotification do
  @moduledoc ~S'''
  GraphQL object `CustomerNeedNotification`.
  ...
  | `customerNeed` | LinearSDK.Objects.CustomerNeed! | `none` | No | The customer need related to the notification. |
  | `customerNeedId` | LinearSDK.Scalars.String! | `none` | No | Related customer need. |
  ...
  | `relatedIssue` | LinearSDK.Objects.Issue | `none` | No | The issue related to the notification. |
  | `relatedProject` | LinearSDK.Objects.Project | `none` | No | The project related to the notification. |
